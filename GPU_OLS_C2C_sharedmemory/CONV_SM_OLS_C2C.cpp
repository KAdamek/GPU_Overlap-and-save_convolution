...
int main(int argc, char* argv[]) {
	...
	GPU_convolution_OLS_customFFT(h_input, h_output, h_filters_padded, signal_length, convolution_length, corrected_filter_length, past_filter_samples, nFilters, nRuns, kernel_type, &execution_time);
