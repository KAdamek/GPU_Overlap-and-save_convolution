...
void Full_CONV_check(float2 *GPU_result, float2 *h_input, float2 *h_filters, int signal_length, int filter_length, int useful_part_size, int conv_length, int nConvolutions, int nFilters, double *cumulative_error, double *mean_error){
