...
int GPU_convolution_OLS_customFFT(float2 *h_input_signal, float2 *h_output_plane, float2 *h_filters, int signal_length, int convolution_length, int filter_length, int nFilters, int nRuns, float h, int offset_modifier, int kernel_type, double *execution_time);
...
int main(int argc, char* argv[]) {
	...
	GPU_convolution_OLS_customFFT(h_input, h_output, h_filters_padded, signal_length, convolution_length, filter_length, nFilters, nRuns, h, offset_modifier, kernel_type, &execution_time);
