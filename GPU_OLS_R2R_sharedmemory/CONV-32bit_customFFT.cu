...
void conv_OLS_R2R_customFFT(float2 *d_input_signal, float2 *d_output_plane, float2 *d_filters, int signal_length, int convolution_length, int useful_part_size, int offset, int nConvolutions, int nFilters){
...
void convolution_via_customFFT_benchmark(float *d_input_signal, float *d_output_plane, float *d_filters_timedom, int signal_length, int convolution_length, int useful_part_size, int offset, int nConvolutions, int nFilters, double *CONV_time){
	...
	CONV_init();
	conv_OLS_R2R_customFFT((float2 *) d_input_signal, (float2 *) d_output_plane, d_filters_freqdom, (signal_length>>1), convolution_length, (useful_part_size>>1), (offset>>1), nConvolutions, nFilters);
...
int GPU_convolution_OLS_customFFT(float *h_input_signal, float *h_output_plane, float *h_filters_timedom, int signal_length, int convolution_length, int filter_length, int nFilters, int nRuns, int device, double *execution_time){
